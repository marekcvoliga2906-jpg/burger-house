...
include __DIR__ . '/includes/FormHandler.inc.php';
        ...
        <div class="form-card" id="contact-form">
                ...
                <div class="form-grid">
                    ...
                    <div class="field field--full">
                        ...
                        <textarea
                            id="message"
                            name="message"
                            placeholder="Tell us what you need"><?php echo htmlspecialchars($message, ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>
                </div>
            ...
            <?php if ($formError !== ''): ?>
                ...
                <div class="contact-card mt-16">
                    ...
                    <p>
                        All form fields are required before sending the message.
                    </p>
                </div>
